...
(library Library_1
	...
	(compDef "4677" (originalName "4677") (compHeader (numPins 8) (numParts 1) (refDesPrefix J)
		...
		(compPin "2" (pinName "SO/SIO[1]") (partNum 1) (symPinNum 2) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "3" (pinName "SIO[2]") (partNum 1) (symPinNum 3) (gateEq 0) (pinEq 0) (pinType Unknown))
		...
		(compPin "7" (pinName "SIO[3]") (partNum 1) (symPinNum 6) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "6" (pinName "SCLK") (partNum 1) (symPinNum 7) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "5" (pinName "SI/SIO[0]") (partNum 1) (symPinNum 8) (gateEq 0) (pinEq 0) (pinType Unknown))
		...
		(attr "<Hyperlink>" "https://www.espressif.com/sites/default/files/documentation/esp-psram64_esp-psram64h_datasheet_en.pdf")
		(attr "<Component Height>" "1.75")
		(attr "<STEP Filename>" "4677.stp")
